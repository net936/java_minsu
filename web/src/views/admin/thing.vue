      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="民宿名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="等级" name="level">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.level">
                    <a-select-option key="三星级" value="三星级">三星级</a-select-option>
                    <a-select-option key="四星级" value="四星级">四星级</a-select-option>
                    <a-select-option key="五星级" value="五星级">五星级</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="配套设施" name="sheshi">
